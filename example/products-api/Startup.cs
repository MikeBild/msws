...
namespace app
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddCors(options => options.AddPolicy("AllowWebApi", builder => builder.AllowAnyMethod().AllowAnyMethod().AllowAnyOrigin()));
      services.AddTransient<IProductsRepository>(x => new ProductsRepository());
    }
